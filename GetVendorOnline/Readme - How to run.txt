...
It is an web application to put each and every vendor online, so users can choose their vendor easily and contact
them via 3rd party involvment. It contains so many features and the project is still in developing phase.

Features : Login; Registration; (Still to develope); Different Services; Vendor selection so on...
...
2. For example : After copying the foler into www folder of WAMP server
	...
	b. on the main page, under your project, you can find "GetVendorOnline" folder.
